...
锚点状态（DEC-011）：本文件锚点与词表为 agent 起草初稿，用户改定前
...
ANCHOR_DRAFT_STATUS = "draft"  # agent 初稿；用户改定后置 "user_finalized"
...
DIMENSIONS: list[dict[str, Any]] = [
    {
        "key": "需求兑现",
        "question": "创作需求（题材、核心创意、主角设定、填写过的侧重与风格）在最终大纲中是否有可观察的兑现？",
        "anchors": {
            "1": "题材错位、核心创意被丢弃或替换，或主角设定与大纲人物明显矛盾",
            "3": "核心创意与主角设定保留，但侧重或风格要求部分落空，存在未经说明的漂移",
            "5": "题材准确、核心创意贯穿三件套、主角设定忠实采用，填写过的侧重与风格均有可观察兑现",
        },
        "defect_tags": ["题材错位", "创意丢失", "主角设定矛盾", "侧重未落实", "风格偏离"],
    },
    {
        "key": "设定自洽",
        "question": "世界观与力量体系的规则是否内部一致、跨三件套无矛盾、可稳定推演？",
        "anchors": {
            "1": "规则互相矛盾或可被随意改写（能力成为万能解法），三件套间存在实质冲突",
            "3": "核心规则可用，但层级、边界或代价仍有模糊处，三件套有局部不一致",
            "5": "规则、限制、代价形成闭环、可稳定推演，主线/人物/世界观三件套无实质冲突",
        },
        "defect_tags": ["规则冲突", "能力无代价", "体系断层", "跨件套矛盾", "设定空洞"],
    },
    {
        "key": "人物塑造",
    ...
    {
        "key": "节奏结构",
        "question": "蓝图级结构是否清晰，张弛节奏与关键转折/爽点分布是否有设计感？",
        "anchors": {
            "1": "无结构可言或节奏全篇均质，无转折设计",
            "3": "有基本结构框架，但高潮前置、中段松散或爽点分布无规律",
            "5": "阶段划分清晰，铺垫-爆发-回落有节奏，转折与爽点分布有明确设计且密度得当",
        },
        "defect_tags": ["结构混乱", "节奏均质", "中段松散", "高潮缺失", "爽点稀薄"],
    },
]
